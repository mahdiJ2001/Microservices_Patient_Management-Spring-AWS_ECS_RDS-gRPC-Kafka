...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Email is required") @Email(message = "Email should be valid") String getAddress() {
        return address;
    }

    public void setAddress(@NotBlank(message = "Email is required") @Email(message = "Email should be valid") String address) {
    ...
    public static @NotNull(message = "Registered date is required") String getRegisteredDate() {
